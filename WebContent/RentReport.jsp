...
<h1 style="text-align:center"><b>Agent Rent Report</b></h1>
	...
	<h2 style="background-color: #cce6ff; padding: 8px 10px;">Properties Rented</h2>
	...
	<table class="properties" style="width: 80%; padding: 4px;">
		<tr>
			...
			<th>Parking&emsp;</th>
			<th>Rent (per month)&emsp;</th>
			<th>Rental Commencement Date </th>
		...
		<% for(PropertyModel property: deals_in){
				if(property.getBooking_status().equalsIgnoreCase("Booked") && property.getProperty_for().equalsIgnoreCase("Rent")) {
			...
			%>		<tr>
					    ...
					    <td><%= property.getLast_date() %>&emsp;</td>  
					</tr>
			...
			out.println("Agent has not rented any properties yet!");%>
